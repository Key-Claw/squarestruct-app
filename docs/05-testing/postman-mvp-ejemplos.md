...
7. Probar la base de pedidos como comprobacion tecnica del backend.
...
| `409 Conflict` | El email ya esta registrado o no se puede eliminar un usuario con dependencias. |
